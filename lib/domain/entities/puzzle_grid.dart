...
class PuzzleGrid extends PuzzleBaseEntity {
  const PuzzleGrid({required super.cellSize, required super.rows, required super.columns, required super.origin});

  factory PuzzleGrid.initial() => const PuzzleGrid(cellSize: 1, rows: 1, columns: 1, origin: Offset.zero);

  factory PuzzleGrid.fromSerializable(final Map<String, dynamic> map) => PuzzleGrid(
