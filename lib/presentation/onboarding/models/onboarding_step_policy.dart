...
extension OnboardingStepIdPolicyX on OnboardingStepId {
  ...
  bool get showsCompletionMessage =>
      ...
      this == OnboardingStepId.drawPiece ||
  ...
  OnboardingInputAction? get allowedInputAction {
    ...
    if (this == OnboardingStepId.drawPiece) {
      return OnboardingInputAction.drag;
    }
  ...
  String instructionText({required final bool isInteractionEnabled}) {
    if (this == OnboardingStepId.dragPiece) {
      return isInteractionEnabled ? S.current.onboardingDragTryNow : S.current.onboardingDragPrompt;
    }
    if (this == OnboardingStepId.drawPiece) {
      return isInteractionEnabled ? S.current.onboardingDrawTryNow : S.current.onboardingDrawPrompt;
    }
    if (this == OnboardingStepId.rotatePiece) {
      return isInteractionEnabled ? S.current.onboardingRotateTryNow : S.current.onboardingRotatePrompt;
    }
    if (this == OnboardingStepId.flipPiece) {
      return isInteractionEnabled ? S.current.onboardingFlipTryNow : S.current.onboardingFlipPrompt;
    }
